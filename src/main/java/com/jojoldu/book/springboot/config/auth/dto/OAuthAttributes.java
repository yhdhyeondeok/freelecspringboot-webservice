...
public class OAuthAttributes {
    ...
    public static OAuthAttributes of(String registrationld, String userNameAttributeName,
                                     Map<String, Object> attributes) {
        if("naver".equals(registrationld)) return ofNaver("id",attributes);
    ...
    public static OAuthAttributes ofNaver(String userNameAttributeName,
        ...
        return OAuthAttributes.builder().name((String)response.get("name"))
                ...
                .picture((String) response.get("profilelmage"))
                .attributes(response)
                .nameAttributeKey(userNameAttributeName)
                .build();
    }
